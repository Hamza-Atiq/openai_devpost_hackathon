...
const defaultFixtures: FixtureWeatherView[] = [
  { id: "G01", label: "Falcons vs Lions", venue: "National Cricket Ground", startsAt: "2026-09-07T10:00:00+05:00", risk: 18 },
  { id: "G04", label: "Mariners vs Royals", venue: "Riverside Oval", startsAt: "2026-09-08T18:00:00+05:00", risk: 46 },
  { id: "G07", label: "Strikers vs United", venue: "National Cricket Ground", startsAt: "2026-09-10T18:00:00+05:00", risk: 78 },
];
...
export function WeatherRiskPanel({ coverage = 100, issuedAt = "31 Aug 2026, 14:00 PKT", stale = false, provider = "Open-Meteo", fixtures = defaultFixtures, allocationMinutes = 240 }: WeatherRiskPanelProps) {
